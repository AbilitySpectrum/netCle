 ...
 * @author Andrew
 */
public class ConnectionOLD implements SerialCallback {
    private static final ResourceBundle RES = ResourceBundle.getBundle("strings");
    private static ConnectionOLD instance = null;
    
    public static ConnectionOLD getInstance() {
        if (instance == null) {
            instance = new ConnectionOLD();
        }
        return instance;
    }
