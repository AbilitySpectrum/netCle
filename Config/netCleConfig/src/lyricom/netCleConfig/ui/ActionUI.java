...
public class ActionUI {
    ...
    static final ValueLabelPair HID_Keys_Extended[] = {
        ...
        new ValueLabelPair( 0x2B, "Plus Key"),
        new ValueLabelPair( 0x2D, "Minus Key"),
        new ValueLabelPair( 0x60, "Back Quote"),
        new ValueLabelPair( 0x5B, "Open Square Bracket"),
        new ValueLabelPair( 0x5D, "Closed Square Bracket"),
        new ValueLabelPair( 0x7B, "Open Curly Bracket"),
        new ValueLabelPair( 0x7D, "Closed Curly Bracket"),
